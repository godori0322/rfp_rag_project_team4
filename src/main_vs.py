...
def load_documents(filename: str, metadata, page_chunk_size: int = 1500, page_chunk_overlap: int = 150, final_chunk_size: int = 500, final_chunk_overlap: int = 100) -> List[Document]:
    """
    ...
    page_splitter = TextSplitter(chunk_size=page_chunk_size,chunk_overlap=page_chunk_overlap)
